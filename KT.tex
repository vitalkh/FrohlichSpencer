...
$$
e(f_1, \beta) \leq e^{-(ln2)\frac{\beta}{25\pi}q^2},
$$
where $\abs{q} \geq 1$ holds for $q = \sum_{k \in \Omega_1} f_1(k) = \sum_{k \in \Omega_1} \varrho^*(k)$ (as $Q(R_0(\varrho^* \cap s)) = Q(\varrho^* \cap s)$).
%q := \sum_{k \in \Omega_1}\varrho^*(k)
